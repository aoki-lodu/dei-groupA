...
POLICIES_DB = [
    ...
    {"name": "ビザスポンサー", "target": ["🌏"], "power": 3, "type": ["recruit", "shield", "power"]},
    {"name": "リロケーション支援", "target": ["🌏"], "power": 3, "type": ["recruit", "shield", "power"]},
    # --- ⚖️ フェア ---
    ...
    {"name": "構造化面接", "target": ["📖", "⚖️"], "power": 2, "type": ["recruit", "promote", "power"]},
    {"name": "インクルーシブJD", "target": ["📖", "🌈", "⚖️"], "power": 1, "type": ["recruit", "power"]},
    {"name": "心理的安全性ルーチン", "target": ["🌈", "⚖️"], "power": 1, "type": ["promote", "shield", "power"]},
    {"name": "有償ワークサンプル", "target": ["💚", "📖"], "power": 1, "type": ["recruit", "power"]},
    {"name": "メンタリング＆スポンサー", "target": ["🌈", "⚖️"], "power": 1, "type": ["promote", "shield", "power"]},
    {"name": "面接官トレーニング", "target": ["🌈", "⚖️"], "power": 1, "type": ["recruit", "promote", "power"]},
    {"name": "公正なアサイン管理", "target": ["🌈", "⚖️"], "power": 2, "type": ["promote", "power"]},
    {"name": "オンボーディング90日", "target": ["📖", "🌏"], "power": 2, "type": ["shield", "power"]},
    {"name": "復帰ブリッジ（育休/介護）", "target": ["💚", "📖"], "power": 2, "type": ["promote", "shield", "power"]},
    {"name": "透明な評価会（校正）", "target": ["🌈", "⚖️"], "power": 2, "type": ["promote", "shield", "power"]},
    {"name": "サテライト/在宅手当", "target": ["💚", "🌏"], "power": 2, "type": ["recruit", "shield", "power"]},
    {"name": "内部公募マーケット", "target": ["📖", "🌈"], "power": 2, "type": ["promote", "shield", "power"]},
    {"name": "学習支援（費用・就業内学習）", "target": ["📖", "⚖️"], "power": 3, "type": ["promote", "power"]},
    {"name": "交通・機材サポート", "target": ["💚", "⚖️"], "power": 1, "type": ["recruit", "power"]},
    {"name": "フェア採用ダッシュボード", "target": ["🌈", "⚖️"], "power": 2, "type": ["recruit", "power"]},
    {"name": "ペアワーク＆コードレビュー標準", "target": ["📖", "🌈"], "power": 1, "type": ["promote", "power"]},
    {"name": "アルムナイ/ブーメラン採用", "target": ["📖", "🌏"], "power": 1, "type": ["recruit", "promote", "shield", "power"]},
    {"name": "ATSバイアスアラート運用", "target": ["📖", "🌈"], "power": 2, "type": ["recruit", "power"]},
]
